...
Below is the Entity Relationship Diagram representing the normalized database schema.

It illustrates:

- Primary Keys and Foreign Keys
- One-to-Many relationships
- Business entities and geographic hierarchy
- Inventory and sales flow structure
